...
class RecommendationService:
    def __init__(
        ...
        *,
        ...
        self.signal_reader = signal_reader or LocalSignalReader(Path("./data/signals"))
        self.recommendation_storage = recommendation_storage or LocalRecommendationStorage(Path("./data/recommendations"))
